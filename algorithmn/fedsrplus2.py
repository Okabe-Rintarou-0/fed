...
from tools import aggregate_weights, update_collaborate_vector
...
class FedSRPlus2Server(FedServerBase):
    def __init__(
        self,
        args: Namespace,
    ...
    def train_one_round(self, round: int) -> GlobalTrainResult:
        ...
        agg_weights = update_collaborate_vector(
            idx_clients,
            local_weights_map,
            agg_weights,
            sin_growth(self.alpha, round, self.max_round)
        )
...
class FedSRPlus2Client(FedClientBase):
    def __init__(
        self,
        idx: int,
        args: Namespace,
